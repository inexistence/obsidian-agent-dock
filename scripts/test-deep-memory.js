...
const { extractDeepMemoryCandidates } = require("../src/deepMemory/DeepMemoryExtractor");
...
async function testDeepMemoryRecallsSubtleParaphrase() {
  ...
  assert.equal(saved.length, 2, "explicit prompt and auditable signal should both be eligible in this synthetic turn");
