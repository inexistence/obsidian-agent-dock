...
module.exports = {
  ...
  messages: {
    ...
    "affect.label.alert": "警觉 / 注意风险",
    "affect.label.serious": "严肃 / 谨慎处理",
    "affect.label.reassuring": "安抚 / 稳住来",
    "affect.label.excited-open": "兴奋 / 想一起冲一下",
    "affect.label.surprised": "惊喜 / 眼睛一亮",
    "affect.label.admiring": "赞赏 / 认真认可",
    "affect.label.close": "亲近 / 安静在场",
    "affect.label.celebratory": "开心 / 庆祝一下",
    "affect.label.playful": "轻快 / 有点玩味",
    "affect.label.confident": "笃定 / 可以推进",
    "affect.label.composed": "冷静 / 清楚梳理",
    "affect.label.absorbed": "投入 / 深入共想",
    "affect.label.challenging": "挑战 / 认真质疑",
    "affect.label.patient": "耐心 / 一步步来",
    "affect.label.restrained": "克制 / 简短有力",
